...
export default function ChangePasswordScreen({ navigation }) {
  ...
  const handleSubmit = async () => {
    ...
    setLoading(true);
    try {
      await changePassword(accessToken, tempPassword, newPassword);
        ...
        >
          ...
          <View style={styles.fieldWrap}>
            ...
            <View style={styles.passWrap}>
              ...
              <TouchableOpacity onPress={() => setShowTemp(!showTemp)}>
                <Ionicons
                  name={showTemp ? 'eye-off-outline' : 'eye-outline'}
                  size={18}
          ...
          >
            {loading
              ...
              : <Text style={styles.btnPrimaryText}>Confirm &amp; continue</Text>
            }
          </TouchableOpacity>

          <Text style={styles.skipNote}>You cannot skip this step</Text>
        </ScrollView>
      </KeyboardAvoidingView>
    </SafeAreaView>
  );
